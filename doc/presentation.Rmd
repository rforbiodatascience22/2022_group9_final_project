...
author: "Group 9 - Huang Yi (s210304), Liu Yu (S212610), Anne Rossen (s194687), Synne Spjelkavik (s174526)"
date: '2022-05-09'
output:
...
<<<<<<< HEAD
<font size="4"> In this project we will investigate whether it is possible to detect and correctly classify the 4 breast cancer subtypes using different sets of protein expression data and compare the results of the classification.</font>
=======
...
>>>>>>> f924c22a8904841d1cdea2b7b3df4c550cc0fbe6
...
- Instead of common genes then unique genes
- Method very reproducible
